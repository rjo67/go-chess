...
func TestInitialPosition(t *testing.T) {
	doTest(moveData{"rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 0", colour.White, []int{20, 400, 8902, 197281, 4865609}}, t)
}
func TestPosn2(t *testing.T) {
	doTest(moveData{"r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq - 0 0", colour.White, []int{48, 2039, 97862, 4085603}}, t)
}
func TestPosn3(t *testing.T) {
	doTest(moveData{"8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 0", colour.White, []int{14, 191, 2812, 43238, 674624}}, t)
}
func TestPosn5(t *testing.T) {
	doTest(moveData{"rnbqkb1r/pp1p1ppp/2p5/4P3/2B5/8/PPP1NnPP/RNBQK2R w KQkq - 0 6", colour.White, []int{42, 1352, 53392}}, t)
}
func TestPosn6(t *testing.T) {
	doTest(moveData{"r4rk1/1pp1qppp/p1np1n2/2b1p1B1/2B1P1b1/P1NP1N2/1PP1QPPP/R4RK1 w - - 0 10", colour.White, []int{46, 2079, 89890, 3894594 /*, 164075551*/}}, t)
}
func TestNumpty2(t *testing.T) {
	doTest(moveData{"8/p7/8/1P6/K1k3p1/6P1/7P/8 w - - 0 10", colour.White, []int{5, 39, 237, 2002, 14062, 120995, 966152}}, t)
}
func TestNumpty3(t *testing.T) {
	doTest(moveData{"r3k2r/p6p/8/B7/1pp1p3/3b4/P6P/R3K2R w KQkq - 0 10", colour.White, []int{17, 341, 6666, 150072, 3186478}}, t)
}
func TestNumpty4(t *testing.T) {
	doTest(moveData{"8/5p2/8/2k3P1/p3K3/8/1P6/8 b - - 0 10", colour.Black, []int{9, 85, 795, 7658, 72120, 703851}}, t)
}
func TestNumpty5(t *testing.T) {
	doTest(moveData{"r3k2r/pb3p2/5npp/n2p4/1p1PPB2/6P1/P2N1PBP/R3K2R b KQkq - 0 10",
		colour.Black, []int{29, 953, 27990, 909807}}, t)
}
func TestIllegalEpMove1(t *testing.T) {
	doTest(moveData{"8/8/8/8/k1p4R/8/3P4/3K4 w - - 0 1", colour.White, []int{18, -1, -1, -1, -1, 1134888}}, t)
	doTest(moveData{"8/8/8/8/k1p4R/8/3P4/3K4 b - - 0 1", colour.Black, []int{5, -1, -1, -1, -1, 1134888}}, t)
}
func TestIllegalEpMove2(t *testing.T) {
	doTest(moveData{"8/8/4k3/8/2p5/8/B2P2K1/8 w - - 0 1", colour.White, []int{13, -1, -1, -1, -1, 1015133}}, t)
	doTest(moveData{"8/8/4k3/8/2p5/8/B2P2K1/8 b - - 0 1", colour.Black, []int{8, -1, -1, -1, -1, 1015133}}, t)
}
func TestEpCaptureChecksOpponent(t *testing.T) {
	doTest(moveData{"8/5k2/8/2Pp4/2B5/1K6/8/8 w - d6 0 1", colour.White, []int{15, -1, -1, -1, -1, 1440467}}, t)
	doTest(moveData{"8/5k2/8/2Pp4/2B5/1K6/8/8 b - d3 0 1", colour.Black, []int{-1, -1, -1, -1, -1, 1440467}}, t)
}
func TestShortCastlingChecksOpponent(t *testing.T) {
	doTest(moveData{"5k2/8/8/8/8/8/8/4K2R w K - 0 1", colour.White, []int{15, -1, -1, -1, -1, 661072}}, t)
	doTest(moveData{"4k2r/8/8/8/8/8/8/4K2R b k - 0 1", colour.Black, []int{15, -1, -1, -1, -1, 661072}}, t)
}
func TestLongCastlingChecksOpponent(t *testing.T) {
	doTest(moveData{"3k4/8/8/8/8/8/8/R3K3 w Q - 0 1", colour.White, []int{16, -1, -1, -1, -1, 803711}}, t)
	doTest(moveData{"r3k3/8/8/8/8/8/8/3K4 b q - 0 1", colour.Black, []int{16, -1, -1, -1, -1, 803711}}, t)
}
func TestCastlingIncludingLosingOrRookCapture(t *testing.T) {
	doTest(moveData{"r3k2r/1b4bq/8/8/8/8/7B/R3K2R w KQkq - 0 1", colour.White, []int{26, -1, -1, 1274206}}, t)
	doTest(moveData{"r3k2r/1b4bq/8/8/8/8/7B/R3K2R b KQkq - 0 1", colour.Black, []int{47, -1, -1, 1274206}}, t)
}
func TestCastlingPrevented(t *testing.T) {
	doTest(moveData{"r3k2r/8/5Q2/8/8/3q4/8/R3K2R w KQkq - 0 1", colour.White, []int{44, -1, -1, 1720476}}, t)
	doTest(moveData{"r3k2r/8/3Q4/8/8/5q2/8/R3K2R b KQkq - 0 1", colour.Black, []int{44, -1, -1, 1720476}}, t)
}
func TestPromoteOutOfCheck(t *testing.T) {
	doTest(moveData{"2K2r2/4P3/8/8/8/8/8/3k4 w - - 0 1", colour.White, []int{11, -1, -1, -1, -1, 3821001}}, t)
	doTest(moveData{"3K4/8/8/8/8/8/4p3/2k2R2 b - - 0 1", colour.Black, []int{11, -1, -1, -1, -1, 3821001}}, t)
}
func TestDiscoveredCheck(t *testing.T) {
	doTest(moveData{"8/8/8/2k3PR/8/1p2K3/2P2B2/2Q5 w - - 0 10", colour.White, []int{31, -1, -1}}, t)
}
func TestDiscoveredCheck2(t *testing.T) {
	doTest(moveData{"5K2/8/1Q6/2N5/8/1p2k3/8/8 w - - 0 1", colour.White, []int{29, -1, -1, -1, 1004658}}, t)
	doTest(moveData{"8/8/1P2K3/8/2n5/1q6/8/5k2 b - - 0 1", colour.Black, []int{29, -1, -1, -1, 1004658}}, t)
}
func TestSelfStalemate(t *testing.T) {
	doTest(moveData{"8/k1P5/8/1K6/8/8/8/8 w - - 0 1", colour.White, []int{10, -1, -1, -1, -1, -1, 567584}}, t)
	doTest(moveData{"8/8/8/8/1k6/8/K1p5/8 b - - 0 1", colour.Black, []int{10, -1, -1, -1, -1, -1, 567584}}, t)
}
func TestSelfStalemate2(t *testing.T) {
	doTest(moveData{"K1k5/8/P7/8/8/8/8/8 w - - 0 1", colour.White, []int{2, -1, -1, -1, -1, 2217}}, t)
	doTest(moveData{"8/8/8/8/8/p7/8/k1K5 b - - 0 1", colour.Black, []int{2, -1, -1, -1, -1, 2217}}, t)
}
func TestPromotionRocechess(t *testing.T) {
	//www.rocechess.ch/perft.html
	doTest(moveData{"n1n5/PPPk4/8/8/8/8/4Kppp/5N1N b - - 0 1", colour.Black,
		[]int{24, 496, 9483, 182838, 3605103 /* , 71179139 */}}, t)
}
func TestPromotionToGiveCheck(t *testing.T) {
	doTest(moveData{"4k3/1P6/8/8/8/8/K7/8 w - - 0 1", colour.White, []int{9, -1, -1, -1, -1, 217342}}, t)
	doTest(moveData{"4k3/1P6/8/8/8/8/K7/8 w - - 0 1", colour.White, []int{-1, -1, -1, -1, -1, 217342}}, t)
}
func TestUnderPromoteToGiveCheck(t *testing.T) {
	doTest(moveData{"8/P1k5/K7/8/8/8/8/8 w - - 0 1", colour.White, []int{6, -1, -1, -1, -1, 92683}}, t)
	doTest(moveData{"8/8/8/8/8/k7/p1K5/8 b - - 0 1", colour.Black, []int{-1, -1, -1, -1, -1, 92683}}, t)
}
func TestDoubleCheck(t *testing.T) {
	doTest(moveData{"8/5k2/8/5N2/5Q2/2K5/8/8 w - - 0 1", colour.White, []int{37, -1, -1, 23527}}, t)
	doTest(moveData{"8/8/2k5/5q2/5n2/8/5K2/8 b - - 0 1", colour.Black, []int{37, -1, -1, 23527}}, t)
}
...
func doTest(data moveData, t *testing.T) {
	...
	if err != nil {
		...
		if data.expectedNbrMoves[0] == -1 {
			...
			moves := position.FindMoves(data.col)
